            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-6">
                    <div class="text-center section-title">
                        <p class="mb-3 text-primary text-uppercase fw-bold">Contact With us</p>
                            ...
                            <div class="col-lg-6">
                                <div class="contact-form">
                                    <form wire:submit.prevent='submit'>
                                        <div class="pb-2 mb-4 form-group">
                                            <label for="name" class="form-label">Full Name</label>
                                            <input type="text" wire:model='name' name="name" class="shadow-none form-control @error('name')is-invalid @enderror" id="name">
                                             @error('name')
                                        ...
                                        <div class="pb-2 mb-4 form-group">
                                            ...
                                            <input type="email" wire:model='email' name="email" class="shadow-none form-control @error('email')is-invalid @enderror" id="email">
                                            @error('email')
                                            <p class="invalid-feedback">{{$message}}</p>
                                        @enderror
                                        </div>
                                        <div class="pb-2 mb-4 form-group">
                                            ...
                                            <textarea wire:model='message' name="message" class="shadow-none form-control" id="message" rows="3"></textarea>
                                        </div>
                            ...
                            <div class="mt-5 col-lg-6 mt-lg-0">
                                ...
                                <div class="contact-info">
                                    ...
                                    <div class="block">
                                        ...
                                        <ul class="my-4 list-unstyled list-inline social-icons">
                                            <li class="list-inline-item me-3"><a title="Explorer Facebook Profile" target="_blank" class="text-black" href="{{$contactDetails->fb_url}}"><i class="fab fa-facebook-f"></i></a>
                                            </li>
                                            <li class="list-inline-item me-3"><a title="Explorer Twitter Profile" target="_blank" class="text-black" href="{{$contactDetails->tw_url}}"><i class="fab fa-twitter"></i></a>
                                            </li>
                                            <li class="list-inline-item me-3"><a title="Explorer Instagram Profile" target="_blank" class="text-black" href="{{$contactDetails->instagram_url}}"><i class="fab fa-instagram"></i></a>
                                            </li>
                                        </ul>
