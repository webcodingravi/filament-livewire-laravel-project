                        ...
                        <div class="row gy-5">
                            ...
                            <div class="col-md-6" data-aos="fade">
                                <article class="blog-post">
                                    <div class="rounded post-slider slider-sm">
                                       @if ($article->image != '')
                                    ...
                                    <div class="pt-4">
                                        ...
                                        <h2 class="h4"><a class="text-black" wire:navigate href="{{route('blogDetail',$article->slug)}}">{{$article->title}}</a></h2>
                                        <a wire:navigate href="{{route('blogDetail',$article->slug)}}" class="text-primary fw-bold" aria-label="Read the full article by clicking here">Read More</a>
                                    </div>
                                </article>
                            </div>
                    ...
                    <div class="widget">
                        ...
                        <ul class="list-unstyled widget-list">
                            <li class="d-flex widget-post align-items-center">
                                <a class="text-black" wire:navigate href="{{route('blogDetail',$latestArticle->slug)}}">
                                    <div class="flex-shrink-0 widget-post-image me-3">
                                ...
                                <div class="flex-grow-1">
                                    <h5 class="mb-0 h6"><a class="text-black" wire:navigate href="{{route('blogDetail',$latestArticle->slug)}}">{{$latestArticle->title}}</a></h5>
